...
var (
	dg    *Session // Stores a global disgord user session
	dgBot *Session // Stores a global disgord bot session
...
func TestScheduledEvents(t *testing.T) {
	...
	// see https://github.com/traits-oriented/disgord/pull/1032#discussion_r815438303 for more details.
