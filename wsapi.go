...
// UpdateStatusComplex allows for sending the raw status update data untouched by disgord.
func (s *Session) UpdateStatusComplex(usd UpdateStatusData) (err error) {
	// The comment does say "untouched by disgord", but we might need to lie a bit here.
